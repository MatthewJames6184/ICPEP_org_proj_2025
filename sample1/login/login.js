...
const sendToServer = (formElement) => {
...
validateForm('#login', sendToServer);


// IMPORTANT NOTES
/*
	in our use case formGroup is actually class="field input"
*/

// VERY USABLE CODE BY CODE WITH BUBB ON YOUTUBE https://www.youtube.com/watch?v=iyngFd6f8ko